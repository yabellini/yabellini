...
- Serving on the [R Consortium Infrastructure Steering Committee](https://r-consortium.org/governance/isc-charter.html) 🏗️
- Organizing [LatinR](https://latin-r.com/) (,and [CSV,Conf](https://csvconf.com/) x2, [useR!](https://user2021.r-project.org/) [x4](https://user2022.r-project.org/), [JAIIO](https://49jaiio.sadio.org.ar/) [x2](https://50jaiio.sadio.org.ar/), and Congreso de AgroInformatica x7)🚀
- <a rel="me" href="https://fosstodon.org/@yabellini">Posting at Mastodon</a>,  [LinkedIn](https://www.linkedin.com/in/yabellini/) and [BlueSky](https://bsky.app/profile/yabellini.bsky.social) about all these topic that interests me !
...
- Doing Open Source Projects as a Fellow 2026 of the [Sovereing Tech Fellowship](https://www.sovereign.tech/programs/fellowship).
